...
print('WAV RIFF Header (44 bytes)')
print("-" * 20)
...
print(f'ChunkID decode: {chunkID_decode}')
print("-" * 20)
...
print(f'ChunkSize decode: {chunkSize_decode}')
print("-" * 20)
...
print(f'Format decode: {format_decode}')
print("-" * 20)
...
print(f'Subchunck1ID decode: {Subchunck1ID_decode}')
print("-" * 20)
...
print(f'Subchunck1Size decode : {Subchunck1Size_decode}')
print("-" * 20)
...
print(f'Audio format decode: {audio_format_decode}')
print("-" * 20)
...
print(f'Number of Channels decode: {numChannels_decode}')
print("-" * 20)
...
print(f'Sample Rate decode: {SampleRate_decode}')
print("-" * 20)
...
print(f'Byte Rate decode: {ByteRate_decode}')
print("-" * 20)
...
print(f'BlockAlign: {BlockAlign_decode}')
print("-" * 20)
...
print(f'Bits Per Sample: {BitsPerSample_decode}')
print("-" * 20)
...
print(f'Subchunk2Size: {Subchunk2Size_decode}')
